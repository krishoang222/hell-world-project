...
import sty from "./PlasmicProjectHeader.module.css"; // plasmic-import: gzoXJLj0FC6p/css
...
function PlasmicProjectHeader__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.columns__swi2G)}>
        <div className={classNames(projectcss.all, sty.column___75Big)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column__vZttb)}>
          <div className={classNames(projectcss.all, sty.columns__mXyIf)}>
            <div className={classNames(projectcss.all, sty.column__pQbrM)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__op1R)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.column__mq8S)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__zFalS)}>
                {renderPlasmicSlot({
